...
Gather all the ingredients and keep it ready. Heat a tsp of oil in a pan and add the chana dhal and urad dhal and roast till it gets heated. Remove from pan and let it cool down. DONT FRY TOO MUCH AS IT WILL BURN OUT.
...
Then, add the flax seeds and roast till it splutters. Once roasted, remove it from the pan.
...
Then, roast the red chillies, garlic, asafoetida and tamarind with a teaspoon of oil. Finally, roast the curry leaves. Let it cool down completely. Make a coarse/fine powder and store it in an air tight container. Goes well with Idli/Dosa.
